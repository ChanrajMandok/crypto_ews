from token_risk_view_app.scheduler import logger
...
class SchedulerTokenPriceChangeDbManager(SchedularDbEventManagerInterface):
    pass
    ...
    #     self._service_binance_db_event_manager = ServiceTokenPriceDbEventManager()
