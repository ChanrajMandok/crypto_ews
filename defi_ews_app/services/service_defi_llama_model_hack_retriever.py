...
from defi_ews_app.decorator.decorator_defi_llama_urls_required import \
                                                 defi_llama_url_required
from defi_ews_app.decorator.decorator_defi_llama_headers_required import \
                                               defi_llama_headers_required
from defi_ews_app.converters.converter_defi_llama_list_to_model_hack \
...
class ServiceDefiLlamaModelHackRetriever(ServiceDefiHtmlRetrieverInterface):
    ...
    def __init__(self,
        ...
        self._store_db_defi_last_updated = StoreDefi.store_db_defi_llama_last_updated
