...
from defi_ews_app.services.service_defi_lama_model_hack_retriever \
                            import ServiceDefiLamaModelHackRetriever
from defi_ews_app.converters.converter_model_defi_hack_to_model_event \
...
class ServiceDefiDbEventUpdater(ServiceDbEventUpdaterInterface):
    ...
    def __init__(self) -> None:
        ...
        self.service_defi_lama_model_hack_raw_retriever = \
                            ServiceDefiLamaModelHackRetriever()
    ...
    def store_db_last_updated(self):
        return self._store_db_defi_last_updated 
