...
from defi_ews_app.scheduler import logger
from defi_ews_app.services.service_defi_llama_db_event_updater import \
                                              ServiceDefiLlamaDbEventUpdater
...
class SchedularDefiLlamaEventDbUpdater(SchedularDbEventUpdaterInterface):
    ...
    def __init__(self) -> None:
        ...
        self._service_defi_llama_db_event_updater = ServiceDefiLlamaDbEventUpdater()
