...
class ServiceBinanceRawArticleKeywordClassifierInterface(metaclass=abc.ABCMeta):
    ...
    def __init__(self) -> None:
        self.__store_db_last_updated  = self.store
        self._converter_a_to_ma      = self.converter_ra_to_a
    ...
    def classify_articles(self, raw_articles: list[model_article_raw]) -> list[model_article]:
        ...
        for model_raw_article_object in raw_articles:
            ...
            article_model = self._converter_a_to_ma().convert(alert_priority=priority,
