"""
Django settings for crypto_ews project.
...
INSTALLED_APPS = [
    ...
    'coinmarketcap_ews_app.apps.CoinmarketcapEwsAppConfig',
]
...
WSGI_APPLICATION = 'crypto_ews.wsgi.application'
...
SHELL_PLUS_IMPORTS = [
    ...
    'from coinmarketcap_ews_app.services.service_coinmarketcap_token_liquidity_event_updater import ServiceCoinMarketCapLiquidityEventDbEventUpdater',
]